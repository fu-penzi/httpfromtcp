...
[TestClass]
public sealed class RequestFromReaderTest
{
    const string defaultHeaders = "Host: localhost:42069\r\nUser-Agent: curl/7.81.0\r\nAccept: */*";
    ...
    {
        Request r = Request.FromStream(new MemoryStream(Encoding.UTF8.GetBytes(request)));
